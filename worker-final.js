...
七、排版审美要求（极其重要，决定阅读体验）
中文排版的核心是「克制」——中文方块字视觉密度天然高于英文，要用减法抵消满感。

段落节奏：
· 每段不超过 4 行。超过就拆成两段，给读者喘息空间
· 段落之间空一行，形成清晰的视觉块
· 长短句交错——长句讲道理，短句做结论。避免连续 3 句以上长句
· 一句话不要超过 40 个字

字重克制：
· 一份报告里「」强调不超过 8 处。只有在真正的关键词上才用
· 不要连续两句话都用强调
· 标题靠字号区分层级，不靠加粗

密度控制：
· 每个【部分】之间空两行，制造明确的翻页感
· 列表项每项不超过一行半
· 复杂数据用 "A vs B" 的对比结构，而非堆砌数字

语言节奏：
· 专业但不学究——像资深顾问在咖啡馆跟你聊天，不是教授在讲课
· 每说完一个观点，用一句人话总结它对你意味着什么
· 多用 "你"（对话感），少用 "该企业""该用户"（报告腔）
· 开头先肯定，中间讲问题，结尾给希望——三明治结构

核心心法：排版不是为了好看，是让读者忘记自己在阅读。你的文字应该像水一样流进大脑，没有任何阻力。`;
